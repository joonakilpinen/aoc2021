...
rm -rf tickets
do_the_bingo_thingy
echo "Part 2 - Last winner: $WINNER, Number: $NUMBER, Unmarked sum: $UNMARKED_SUM, Solution: $((NUMBER * UNMARKED_SUM))"